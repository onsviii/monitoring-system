...
export const ProgressStepper: React.FC<ProgressStepperProps> = ({
  ...
  const steps = [
    ...
    {
      key: 'EXTRACTING_CHARACTERISTICS',
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h4 className="font-bold text-sm text-gray-900">
                {currentStatus === 'PENDING' ? 'Ініціалізація та постановка в чергу...' : 'Запущено фоновий обчислювальний аналіз'}
              </h4>
            </div>
          </div>
            ...
            return (
                <div key={step.key} className="relative flex items-start gap-4">
                  ...
                  <div className="space-y-1">
                    ...
                    {status === 'active' && currentStatus !== 'PENDING' && (
                    ...
                    {status === 'active' && currentStatus === 'PENDING' && (
                        <span className="inline-block bg-amber-100/50 text-amber-700 text-[9px] px-2 py-0.5 rounded font-mono font-medium tracking-wide mt-1 animate-pulse">
                    В ОЧІКУВАННІ...
                  </span>
                    )}
                  </div>
